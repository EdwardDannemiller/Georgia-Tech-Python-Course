...
#payment
mePayAndApprove = can_afford and destination_is_safe
parentPayAndApprove = ((not can_afford) and destination_is_safe and (educational_value or relatives_nearby))

canPay = mePayAndApprove or parentPayAndApprove 

#ability to go
canGoInt = is_international and have_passport and not afraid_to_fly
canGoDom = (not is_international) and (have_a_car or (not afraid_to_fly))

canGo = canGoInt or canGoDom

#desire
wantBeach = is_a_beach and is_warm
wantSki = has_skiing and (not is_warm)
wantCity = is_a_city and (is_off_peak or has_attraction)

wantPlace = wantBeach or wantSki or wantCity

print(canPay and canGo and wantPlace)
